...
public class Schematic {
	...
	public static Schematic getSchematic(String building,int level, int style, int direction){
		try {
			return new Schematic(building+level+style+direction);
		} catch (IOException e) {
...
private void log(String in){
    	System.out.println("[Schematic.java Debug] " + in);
}
